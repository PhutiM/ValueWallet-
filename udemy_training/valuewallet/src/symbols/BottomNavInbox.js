...
export default class BottomNavInbox extends Component {
  render() {
    return (
      <View style={[styles.root, this.props.style]}>
        <View style={styles.group23}>
          ...
          <View style={styles.plus3}>
            <Svg viewBox={"-0 -0 44 44"} style={styles.oval6}>
              <Path
                strokeWidth={0}
          ...
          <View style={styles.group3}>
            <View style={styles.rectangleCopy63} />
            <Image
              viewBox={"0 0 26 26"}
              svgDims={{
                x: "0",
          ...
          <View style={styles.group73}>
            ...
            <View style={styles.homeIconSilhouette3}>
              <Svg
          ...
          <View style={styles.group93}>
            <View style={styles.rectangleCopy43} />
          ...
          <View style={styles.group83}>
            <View style={styles.rectangleCopy73} />
            <View style={styles.sms3}>
              <Svg

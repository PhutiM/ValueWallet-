...
export default class BottomNavProfile extends Component {
  render() {
    return (
      <View style={[styles.root, this.props.style]}>
        <View style={styles.group2}>
          ...
          <View style={styles.plus}>
            <Svg viewBox={"-0 -0 44 44"} style={styles.oval3}>
              <Path
                strokeWidth={0}
          ...
          <UiBarsHomeIndicatorHomeIndicatorOnLight
            style={styles.uiBarsHomeIndicatorHomeIndicatorOnLight}
          />
          ...
          <View style={styles.group7}>
            ...
            <View style={styles.homeIconSilhouette}>
              <Svg

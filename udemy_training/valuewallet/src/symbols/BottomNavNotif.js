...
export default class BottomNavNotif extends Component {
  render() {
    return (
      <View style={[styles.root, this.props.style]}>
        <View style={styles.group21}>
          ...
          <View style={styles.plus1}>
            <Svg viewBox={"-0 -0 44 44"} style={styles.oval4}>
              <Path
                strokeWidth={0}
          ...
          <UiBarsHomeIndicatorHomeIndicatorOnLight
            style={styles.uiBarsHomeIndicatorHomeIndicatorOnLight1}
          />
          <View style={styles.group1}>
            <View style={styles.rectangleCopy61} />
            <Image
              viewBox={"0 0 26 26"}
              svgDims={{
                x: "0",
          ...
          <View style={styles.group71}>
            ...
            <View style={styles.homeIconSilhouette1}>
              <Svg
          ...
          <View style={styles.group81}>
            <View style={styles.rectangleCopy71} />
            <View style={styles.sms1}>
              <Svg
...
const styles = StyleSheet.create({
  ...
  uiBarsHomeIndicatorHomeIndicatorOnLight1: {
    top: "63.04%",
    left: "0.00%",
    width: "100.00%",
    height: "36.96%",

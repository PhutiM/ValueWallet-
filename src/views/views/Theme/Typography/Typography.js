...
class Typography extends APIService {
  ...
  render() {
   ...
   const options = {
    ...
    return (
      ...
      >
        <TableHeaderColumn dataField="campaign_id" isKey dataAlign="left">Id</TableHeaderColumn>
        <TableHeaderColumn dataField="description" dataAlign="left">description</TableHeaderColumn>
        <TableHeaderColumn dataField="status_id" dataAlign="left">Status</TableHeaderColumn>
